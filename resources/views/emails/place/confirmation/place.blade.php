...
<html>
<head>
    <title>PLACE ACCOUNT CONFIRMATION</title>
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 10px 0;" class="logo">
                        <a href="http://litmus.com" target="_blank">
                            <img alt="" src="http://placapp.com/assets/pages/img/logo_plac.png" width="100"
                                 height="100"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center"
                                    ...
                                    class="padding-copy">Verifique por favor la direccion de correo electronico.
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                                    ...
                                    class="padding-copy">
                                    Gracias {!!$name_place!!} por crear una cuenta con PLAC, Por favor siga el link que
                                    hay en la parte de abajo para verificar la direccion de correo electronico
                                    <br>

                                    {{ URL::to('dashboard/place/confirm/'.$id.'/'.$confirmation_code) }}
                                    .<br/>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td align="center" style="border-radius: 3px;"
                                                            bgcolor="#20adae"><a
                                                                    href="{{ URL::to('dashboard/place/confirm/'.$id.'/'.$confirmation_code) }}"
                                                                    target="_blank"
                                                                    ...
                                                                    class="mobile-button">Confirmar email</a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;"
                ...
                <tr>
                    <td align="center"
                        ...
                        <br>
                        <a href="http://litmus.com" target="_blank" style="color: #666666; text-decoration: none;">Conócenos </a>
                        <span style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                        <a href="http://litmus.com" target="_blank" style="color: #666666; text-decoration: none;">Contáctanos </a>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
