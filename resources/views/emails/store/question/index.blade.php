...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        $questionTxt=$question['question_txt'];
                                                ...
                                                <tr align="right" >
                                                    <td  align="right" >
                                                        ...
                                                        <a href="#" target="_blank">
                                                            <img  style="margin-top:20px;margin-left:20px;" src="https://res.cloudinary.com/plac-web/image/upload/q_60/v1508862950/page/main/logo/plac-green.png" alt="" width="40" height="40"  align="left"/>
                                                        </a> 
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="left" style="padding:10px 50px 50px 50px">

                                                        <p style="color:#262626; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>Pregunta sobre el producto</strong></p>
                                                                ...
                                                                <tr>
                                                                    <td align="center" >
                                                                        <table border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                                                            <tr>
                                                                                <td>
                                                                                    <img width="80"  height="80" src="@php echo $productImage; @endphp"/>
                                                                                </td>
                                                                                <td>

                                                                                    <div style="font-size:18px">{{$productName}}</div>
                                                                                    <div style="font-size:15px">sku: {{$productSKU}}</div> 
                                                                                    <div style="font-size:15px">Unidades disponibles: {{$productQuantity}}</div> 
                                                                                </td>
                                                        ...
                                                        <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">{{$questionTxt}}<br />
                                                            <br />
                                                            <br />
                                                        </p>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                                                            <tr>
                                                                                <td width="250" height="50" align="center" bgcolor="#20adae" style="-moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius:5px;"><a href="https://www.placapp.com/productos/preguntas/usuario/nueva/@php echo $questionId; @endphp" style="width:250px; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff">Responder</a></td>
                                                                            </tr>
                                                                        </table></td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px "><br />
                                                            ...
                                                            Atentamente, <br />
                                                            @php echo $placUser['plac_user_name']; @endphp</p></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;"><!--[if (gte mso 9)|(IE)]>
                                                        ...
                                                        <div class="column" style="width:100%;max-width:350px;display:inline-block;vertical-align:top;">
                                                            <table class="contents" style="border-spacing:0; width:100%">
                                                                <tr>
                                                                    <td width="100%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><p style="color:#787777; font-size:13px; text-align:left; font-family: Verdana, Geneva, sans-serif"> Todos los derechos reservados 2017<br />
                                                                            AV calle 24 #74-55<br />
                                                                            Bogota, Colombia </p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                    ...
                                                                    <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%">
                                                                            <tr>
                                                                                <td width="32%" align="center" valign="top" style="padding-top:10px"><table width="150" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td width="33" align="center"><a href="#" target="_blank"><img src="https://res.cloudinary.com/plac-web/image/upload/t_media_lib_thumb/v1509397198/page/icons/facebook-logo-button.png" alt="facebook" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                                                                        </tr>
                                                                                    </table></td>
                                                                            </tr>
                                                                        </table></td>
