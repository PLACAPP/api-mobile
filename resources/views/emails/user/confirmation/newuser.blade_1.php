                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center"
                                    ...
                                    class="padding-copy">Verifica la dirección de correo electrónico.
                                </td>
                            </tr>
                            <tr>
                                <td align="left"
                                    ...
                                    class="padding-copy">
                                    Gracias, {!!$name_user!!} por crear una cuenta con PLAC, Por favor sigue el link que
                                    se encuentra en la parte de abajo para verificar la dirección de correo electrónico
                                    <br>

                                    {{ URL::to('placuser/confirm/'.$email_user.'/'.$confirmation_code) }}
                                    .<br/>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td align="center" style="border-radius: 3px;"
                                                            bgcolor="#20adae"><a
                                                                    href=" {{ URL::to('placuser/confirm/'.$email_user.'/'.$confirmation_code) }}"
                                                                    target="_blank"
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="max-width: 500px;"
                ...
                <tr>
                    <td align="center"
                        ...
                        <br>
                        <a href="http://www.placapp.com/empresa" target="_blank"
                           style="color: #666666; text-decoration: none;">Conócenos </a>
                        <span style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                        <a href="http://www.placapp.com/empresa" target="_blank"
                           style="color: #666666; text-decoration: none;">Contáctanos </a>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
